...
abstract class BarberDocumentReference
  ...
  late final RatingCollectionReference orders = _$RatingCollectionReference(
    reference,
  );
...
/// getting document references, and querying for documents
/// (using the methods inherited from Query).
abstract class RatingCollectionReference
    implements RatingQuery, FirestoreCollectionReference<RatingQuerySnapshot> {
  factory RatingCollectionReference(
    DocumentReference<Barber> parent,
  ) = _$RatingCollectionReference;

  static Rating fromFirestore(
    DocumentSnapshot<Map<String, Object?>> snapshot,
    SnapshotOptions? options,
  ) {
    return Rating.fromJson(snapshot.data()!);
  }
  ...
  @override
  RatingDocumentReference doc([String? id]);

  /// Add a new document to this collection with the specified data,
  /// assigning it a document ID automatically.
  Future<RatingDocumentReference> add(Rating value);
}

class _$RatingCollectionReference extends _$RatingQuery
    implements RatingCollectionReference {
  factory _$RatingCollectionReference(
    DocumentReference<Barber> parent,
  ) {
    return _$RatingCollectionReference._(
      BarberDocumentReference(parent),
      parent.collection('orders').withConverter(
            fromFirestore: RatingCollectionReference.fromFirestore,
            toFirestore: RatingCollectionReference.toFirestore,
          ),
    );
  }

  _$RatingCollectionReference._(
    this.parent,
    CollectionReference<Rating> reference,
  ) : super(reference, reference);
  ...
  @override
  CollectionReference<Rating> get reference =>
      super.reference as CollectionReference<Rating>;

  @override
  RatingDocumentReference doc([String? id]) {
    return RatingDocumentReference(
      reference.doc(id),
    );
  }
  ...
  @override
  Future<RatingDocumentReference> add(Rating value) {
    return reference.add(value).then((ref) => RatingDocumentReference(ref));
  }

  @override
  bool operator ==(Object other) {
    return other is _$RatingCollectionReference &&
        other.runtimeType == runtimeType &&
        other.reference == reference;
  }
...
abstract class RatingDocumentReference
    extends FirestoreDocumentReference<RatingDocumentSnapshot> {
  factory RatingDocumentReference(DocumentReference<Rating> reference) =
      _$RatingDocumentReference;

  DocumentReference<Rating> get reference;

  /// A reference to the [RatingCollectionReference] containing this document.
  RatingCollectionReference get parent {
    return _$RatingCollectionReference(
  ...
  @override
  Stream<RatingDocumentSnapshot> snapshots();

  @override
  Future<RatingDocumentSnapshot> get([GetOptions? options]);
  ...
  Future<void> set(Rating value);
}

class _$RatingDocumentReference
    extends FirestoreDocumentReference<RatingDocumentSnapshot>
    implements RatingDocumentReference {
  _$RatingDocumentReference(this.reference);

  @override
  final DocumentReference<Rating> reference;
  ...
  Stream<RatingDocumentSnapshot> snapshots() {
    return reference.snapshots().map((snapshot) {
      return RatingDocumentSnapshot._(
        snapshot,
        snapshot.data(),
      );
    });
  ...
  @override
  bool operator ==(Object other) {
    return other is RatingDocumentReference &&
        other.runtimeType == runtimeType &&
        other.parent == parent &&
        other.id == id;
  }
...
class RatingDocumentSnapshot extends FirestoreDocumentSnapshot {
  RatingDocumentSnapshot._(
    this.snapshot,
    this.data,
  );

  @override
  final DocumentSnapshot<Rating> snapshot;

  @override
  RatingDocumentReference get reference {
    return RatingDocumentReference(
      snapshot.reference,
    );
  }
...
abstract class RatingQuery implements QueryReference<RatingQuerySnapshot> {
  @override
  RatingQuery limit(int limit);

  @override
  RatingQuery limitToLast(int limit);

  RatingQuery whereUserUID({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  RatingQuery orderByUserUID({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
    String endBefore,
    RatingDocumentSnapshot? startAtDocument,
    RatingDocumentSnapshot? endAtDocument,
    RatingDocumentSnapshot? endBeforeDocument,
    RatingDocumentSnapshot? startAfterDocument,
  });

  RatingQuery orderByBarberUID({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
...
class _$RatingQuery extends QueryReference<RatingQuerySnapshot>
    implements RatingQuery {
  _$RatingQuery(
    this.reference,
    this._collection,
  );
  ...
  @override
  final Query<Rating> reference;

  RatingQuerySnapshot _decodeSnapshot(
    QuerySnapshot<Rating> snapshot,
  ) {
    final docs = snapshot.docs.map((e) {
      return RatingQueryDocumentSnapshot._(e, e.data());
    }).toList();

    final docChanges = snapshot.docChanges.map((change) {
      return FirestoreDocumentChange<RatingDocumentSnapshot>(
        type: change.type,
        oldIndex: change.oldIndex,
        newIndex: change.newIndex,
        doc: RatingDocumentSnapshot._(change.doc, change.doc.data()),
      );
    }).toList();

    return RatingQuerySnapshot._(
      snapshot,
      docs,
      docChanges,
    );
  ...
  @override
  Stream<RatingQuerySnapshot> snapshots([SnapshotOptions? options]) {
    return reference.snapshots().map(_decodeSnapshot);
  }

  @override
  Future<RatingQuerySnapshot> get([GetOptions? options]) {
    return reference.get(options).then(_decodeSnapshot);
  }

  @override
  RatingQuery limit(int limit) {
    return _$RatingQuery(
      reference.limit(limit),
      _collection,
    );
  }
  ...
  RatingQuery orderByUserUID({
    ...
    return _$RatingQuery(query, _collection);
  }
...
class RatingQuerySnapshot
    extends FirestoreQuerySnapshot<RatingQueryDocumentSnapshot> {
  RatingQuerySnapshot._(
    this.snapshot,
    this.docs,
    this.docChanges,
  );

  final QuerySnapshot<Rating> snapshot;

  @override
  final List<RatingQueryDocumentSnapshot> docs;

  @override
  final List<FirestoreDocumentChange<RatingDocumentSnapshot>> docChanges;
}

class RatingQueryDocumentSnapshot extends FirestoreQueryDocumentSnapshot
    implements RatingDocumentSnapshot {
  RatingQueryDocumentSnapshot._(this.snapshot, this.data);

  @override
  final QueryDocumentSnapshot<Rating> snapshot;

  @override
  RatingDocumentReference get reference {
    return RatingDocumentReference(snapshot.reference);
  }
